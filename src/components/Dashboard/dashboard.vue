    ...
    <div class="slim-header">
      <div class="container">
        <div class="slim-header-left">
          <h2 class="slim-logo"
            ><a href="index.html">slim<span>.</span></a></h2
          >
            ...
            <div class="dropdown-menu">
              ...
              <div class="dropdown-activity-list">
                ...
                <div class="activity-item">
                  <div class="row no-gutters">
                    ...
                    ></div>
                    <div class="col-8"
                      >Purchased christmas sale cloud storage</div
                    > </div
                  ><!-- row --> </div
                ><!-- activity-item -->
                <div class="activity-item">
                  <div class="row no-gutters">
                    ...
                    ></div>
                    <div class="col-8">Login failure</div> </div
                  ><!-- row --> </div
                ><!-- activity-item -->
                <div class="activity-item">
                  <div class="row no-gutters">
                    ...
                    ></div>
                    <div class="col-8">(D:) Storage almost full</div> </div
                  ><!-- row --> </div
                ><!-- activity-item -->
                <div class="activity-item">
                  <div class="row no-gutters">
                    ...
                    ></div>
                    <div class="col-8"
                      >1 item sold <strong>Christmas bundle</strong></div
                    > </div
                  ><!-- row --> </div
                ><!-- activity-item -->
                ...
                <div class="activity-item">
                  <div class="row no-gutters">
                    ...
                    ></div>
                    <div class="col-8"
                      >Earn new badge <strong>Elite Author</strong></div
                    > </div
                  ><!-- row --> </div
                ><!-- activity-item --> </div
              ...
              <div class="dropdown-list-footer">
                <a href="page-activity.html"
                  ><i class="fa fa-angle-down"></i> Show All Activities</a
                >
              </div> </div
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <nav class="nav">
                <a href="page-profile.html" class="nav-link"
                  ><i class="icon ion-person"></i> View Profile</a
                >
                <a href="page-edit-profile.html" class="nav-link"
                  ><i class="icon ion-compose"></i> Edit Profile</a
                >
                <a href="page-activity.html" class="nav-link"
                  ><i class="icon ion-ios-bolt"></i> Activity Log</a
                >
                <a href="page-settings.html" class="nav-link"
                  ><i class="icon ion-ios-gear"></i> Account Settings</a
                >
                <a href="page-signin.html" class="nav-link"
                  ><i class="icon ion-forward"></i> Sign Out</a
                >
              </nav> </div
            ><!-- dropdown-menu --> </div
          ><!-- dropdown --> </div
        ...
        <ul class="nav">
          ...
          <li class="nav-item with-sub active">
            ...
            <div class="sub-item">
              <ul>
                <li class="active"
                  ><a href="page-profile.html">Profile Page</a></li
                >
    ...
    <div class="slim-mainpanel">
      <div class="container">
        <div class="slim-pageheader">
          ...
          <h6 class="slim-pagetitle">My Profile</h6> </div
        ><!-- slim-pageheader -->
        ...
        <div class="row row-sm">
          <div class="col-lg-8">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p class="card-profile-position"
                      >Executive Director at <a href="">ThemePixels, Inc.</a></p
                    >
                    <p>San Francisco, California</p>

                    <p class="mg-b-0"
                      >A consummate human capital management professional with
                      international training and talent management
                      implementations experience across the entire universe...<a
                        href=""
                        >Read more</a
                      ></p
                    > </div
            ...
            <ul class="nav nav-activity-profile mg-t-20">
              <li class="nav-item"
                ><a href="" class="nav-link"
                  ><i class="icon ion-ios-redo tx-purple"></i> Share an
                  update</a
                ></li
              >
              <li class="nav-item"
                ><a href="" class="nav-link"
                  ><i class="icon ion-image tx-primary"></i> Publish photo</a
                ></li
              >
              <li class="nav-item"
                ><a href="" class="nav-link"
                  ><i class="icon ion-document-text tx-success"></i> Add an
                  article</a
                ></li
              > </ul
            ><!-- nav -->
              ...
              <div class="card-body">
                ...
                <div class="row no-gutters">
                  <div class="col-md-4">
                    <a href=""
                      ><img
                        src="http://via.placeholder.com/1024x1280"
                        class="img-fit-cover"
                        alt=""
                    /></a> </div
                  ><!-- col-4 -->
                  <div class="col-md-8">
                    <div class="post-wrapper">
                      <a href="" class="activity-title"
                        >Sailing Basics: 10 Nautical & Sailing Terms To Know</a
                      >
                      <p
            ...
            <div class="card card-experience mg-t-20">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    <h6 class="position-name"
                      >Front-End Engineer / Web Developer</h6
                    >
                    <p class="position-company"
                      >Cebu Machine Intelligence, Inc.</p
                    >
                    <p class="position-year"
                      >Nov 2012 - Present (5 years +) &nbsp;-&nbsp;
                      <a href="">Edit</a></p
                    > </div
                  ><!-- media-body --> </div
                ><!-- media --> </div
              ...
              <div class="card-footer">
                <a href=""
                  >Show more<span class="d-none d-sm-inline">
                    experiences (4)</span
                  >
                  <i class="fa fa-angle-down"></i
                ></a>
                <a href="">Add new</a> </div
              ><!-- card-footer --> </div
            ><!-- card -->
            ...
            <div class="card card-recommendation mg-t-20">
              <div class="card-body pd-25">
                ...
                <div class="media align-items-center mg-y-25">
                  ...
                  <div class="media-body mg-l-15">
                    ...
                    <p class="mg-b-0">Head Architect</p> </div
                  ><!-- media-body -->
                  <span class="tx-12">Nov 20, 2017</span> </div
                ><!-- media -->
              ...
              <div class="card-footer pd-y-12 pd-x-25 bd-t bd-gray-300">
                <a href=""
                  >More recommendations (2) <i class="fa fa-angle-down"></i
                ></a> </div
              ><!-- card-footer -->
            </div> </div
          ><!-- col-8 -->
          ...
          <div class="col-lg-4 mg-t-20 mg-lg-t-0">
            <div class="card card-connection">
              <div class="row row-xs">
                ...
                <div class="col-8"
                  >people viewed your profile in the past 90 days</div
                > </div
              ><!-- row -->
              <hr />
              <div class="row row-xs">
              ...
              <div class="media-list">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Software Engineer</p> </div
                  ><!-- media-body -->
                  <a href=""><i class="icon ion-person-add tx-20"></i></a> </div
                ><!-- media -->
                <div class="media">
                  <img src="http://via.placeholder.com/500x500" alt="" />
                  <div class="media-body">
              ...
              <div class="media-list mg-t-25">
                <div class="media">
                  ...
                  <div class="media-body mg-l-15 mg-t-4">
                    ...
                    <a href="" class="d-block">http://themeforest.net</a> </div
                  ><!-- media-body --> </div
                ><!-- media -->
                <div class="media mg-t-25">
                  ...
                  <div class="media-body mg-l-15 mg-t-4">
                    ...
                    <span class="d-block">+1 234 5678 910</span> </div
                  ><!-- media-body --> </div
                ><!-- media -->
                <div class="media mg-t-25">
                  <div
                  ...
                  <div class="media-body mg-l-15 mg-t-4">
                    ...
                    <span class="d-block">yourname@sample.com</span> </div
                  ><!-- media-body --> </div
                ><!-- media -->
                <div class="media mg-t-25">
                  ...
                  <div class="media-body mg-l-15 mg-t-2">
                    ...
                    <a href="#" class="d-block">@themepixels</a> </div
                  ><!-- media-body --> </div
                ><!-- media --> </div
              ><!-- media-list --> </div
            ><!-- card --> </div
